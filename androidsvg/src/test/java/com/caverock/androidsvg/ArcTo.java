...
public class ArcTo
{
   ...
   public void  testIssue155() throws SVGParseException
   {
      ...
      assertEquals("drawPath('M 163.63701 412.02103 C 151.5 466.03125 139.375 520.0156 127.32401 574.021', Paint(f:ANTI_ALIAS|LINEAR_TEXT|SUBPIXEL_TEXT; h:OFF; s:FILL; tf:android.graphics.Typeface@0; color:#ff000000; ts:16))", ops.get(3));
   }
   ...
   public void  testIssue156() throws SVGParseException
   {
      ...
      //System.out.println(String.join(",", ops));
      assertEquals(6, ops.size());
      assertEquals("drawPath('M 422.77603 332.65903 C 415.15625 323.8125 407.53125 314.96875 399.92102 306.101', Paint(f:ANTI_ALIAS|LINEAR_TEXT|SUBPIXEL_TEXT; h:OFF; s:FILL; tf:android.graphics.Typeface@0; color:#ff000000; ts:16))", ops.get(3));
