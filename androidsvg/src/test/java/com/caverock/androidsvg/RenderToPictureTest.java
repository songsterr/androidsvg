...
@Config(manifest=Config.NONE, sdk=Build.VERSION_CODES.JELLY_BEAN, shadows={MockCanvas.class, MockPath.class, MockPicture.class, MockPaint.class})
public class RenderToPictureTest
{
   ...
   public void renderToPicture() throws SVGParseException
   {
      ...
      assertEquals("drawPath('M 0 0 L 200 0 L 200 100 L 0 100 L 0 0 Z', Paint(f:ANTI_ALIAS|LINEAR_TEXT|SUBPIXEL_TEXT; h:OFF; s:FILL; tf:android.graphics.Typeface@0; ts:16; color:#ff008000))", ops.get(3));
   }
